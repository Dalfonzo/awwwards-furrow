...
const LogoIcon = (props: LogoIconI) => {
  const { setCursorToAccentStyle, setCursorToHoverStyle, setCursorToNormalStyle } = useCursorStyle()
  ...
  return (
    <S.Logo {...props}>
      <svg
        ...
        width="131"
        height="23"
        onMouseLeave={setCursorToNormalStyle}
      >
        <S.Path d="M0 .158v22.399h5.695V14.64h8.992V9.68H5.695V5.23h9.78V.158z" onMouseEnter={setCursorToHoverStyle} />
        <S.Path
          ...
          onMouseEnter={setCursorToHoverStyle}
        />
        <S.Path
        ...
        <S.Path
          ...
          accent
          onMouseEnter={setCursorToAccentStyle}
        />
      </svg>
    </S.Logo>
  )
